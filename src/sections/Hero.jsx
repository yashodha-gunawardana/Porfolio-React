    ...
    return (
        <section id="home" 
            ...
            <div 
                ...
                {/* stripe circle behind image */}
                <div 
                    className="ring-pluse absolute" 
                    style={{
                ...
                {/* ambient glow */}
                <div 
                    className="glow-breathe absolute pointer-events-none" 
                    style={{
