            ...
            <div className="flex flex-col lg:flex-row lg:gap-40 gap-12 max-w-5xl w-full" style={{ position: "relative", zIndex: 1 }}>
                ...
                <div className="about-fade-1 relative flex-shrink-0 flex justify-center lg:block">
                    <div className="img-frame relative z-10 lg:w-[500px] lg:h-[600px] md:w-[250px] md:h-[280px] w-[200px] h-[200px]">
                        ...
                        />
                        {/* top corner */}
                        <div className="absolute lg:-top-[20px] lg:-right-[20px] lg:w-[40px] lg:h-[40px] md:-top-[15px] md:-right-[15px] md:w-[30px] md:h-[30px] -top-[10px] -right-[10px] w-[22px] h-[22px]"
                            style={{ borderTop: "3px solid #0084FF", borderRight: "3px solid #0084FF", zIndex: 20 }} />
                        {/* bottom corner */}
                        <div className="absolute lg:-bottom-[20px] lg:-left-[20px] lg:w-[40px] lg:h-[40px] md:-bottom-[15px] md:-left-[15px] md:w-[30px] md:h-[30px] -bottom-[10px] -left-[10px] w-[22px] h-[22px]"
                    ...
                    <div className="about-fade-4 flex flex-wrap gap-4"
                        ...
                        {stats.map(({ number, label }) => (
                            <div key={label}
                                ...
                                onMouseEnter={e => { e.currentTarget.style.background = "rgba(0,132,255,0.12)"; e.currentTarget.style.borderColor = "rgba(0,132,255,0.5)"; e.currentTarget.style.transform = "translateY(-4px)"; }}
                                onMouseLeave={e => { e.currentTarget.style.background = "rgba(0,132,255,0.06)"; e.currentTarget.style.borderColor = "rgba(0,132,255,0.2)"; e.currentTarget.style.transform = "translateY(0px)"; }}>
